                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #0f172a; border-radius: 8px; margin-bottom: 32px; color: #ffffff;">
                                        <tr>
                                            <td style="padding: 30px;">
                                                ...
                                                <div style="background-color: rgba(255,255,255,0.1); border: 1px dashed rgba(255,255,255,0.2); border-radius: 6px; padding: 12px; display: inline-block; margin-bottom: 20px;">
                                                    <span style="color: #22d3ee; font-family: 'Courier New', Courier, monospace; font-size: 28px; font-weight: 800; letter-spacing: 2px; user-select: all; -webkit-user-select: all;">${studentId}</span>
                                                </div>
                                                ...
                                                <div style="background-color: rgba(255,255,255,0.1); border: 1px dashed rgba(255,255,255,0.2); border-radius: 6px; padding: 12px; display: inline-block;">
                                                    <span style="color: #ffffff; font-family: 'Courier New', Courier, monospace; font-size: 28px; font-weight: 800; letter-spacing: 2px; user-select: all; -webkit-user-select: all;">${examCode}</span>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
...
exports.sendExamResult = async (email, name, examTitle, score, maxScore, integrityScore, questionsAnalysis = []) => {
    try {
        ...
        if (questionsAnalysis && questionsAnalysis.length > 0) {
            ...
            questionsAnalysis.forEach(section => {

                // Section Header
                analysisHtml += `
                    <div style="margin-top: 40px; margin-bottom: 20px; border-bottom: 2px solid #e2e8f0; padding-bottom: 10px;">
                        <span style="color: #0f172a; font-size: 18px; font-weight: 800; letter-spacing: 1px; text-transform: uppercase;">${section.title}</span>
                        <span style="color: #64748b; font-size: 12px; font-weight: 600; margin-left: 10px;">(${section.questions.length} Questions)</span>
                    </div>
                ...
                if (section.questions && section.questions.length > 0) {
                    ...
                    analysisHtml += `<tr><td style="padding: 20px; text-align: center; color: #64748b;">No questions in this section.</td></tr>`;
                }
